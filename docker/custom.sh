...
echo "export PYTHONPATH=\$PYTHONPATH:/opt/carla/PythonAPI/PythonAPI/carla/dist/$(ls /opt/carla/PythonAPI/PythonAPI/carla/dist | grep py$ROS_PYTHON_VERSION.)" >> /opt/carla/setup.bash
echo "export PYTHONPATH=\$PYTHONPATH:/opt/carla/PythonAPI/PythonAPI/carla" >> /opt/carla/setup.bash
