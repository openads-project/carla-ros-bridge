...
apt-get install ros-$ROS_DISTRO-vision-opencv
apt-get install ros-$ROS_DISTRO-rmw-zenoh-cpp
apt-get install ros-$ROS_DISTRO-rqt-image-view
apt-get install ros-$ROS_DISTRO-rqt-gui-py
